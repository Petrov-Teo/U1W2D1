...
*/
console.log("ESERCIZIO 1 Elenca e descrivi i principali datatype in JavaScript. Prova a spiegarli come se volessi farli comprendere a un bambino.")
...
console.log("Es.1 - STRINGA - Si intende per String un (contenitore) con un determinato valore di tipo Testo.")
console.log(stringa)
console.log(stringa1)
console.log(stringa1 + " in realta l'uno è inteso come testo e non come numero")
console.log("ES.2 - NUMBER - Si esprimono tutti i valori decimali")
...
let stringa3 = "Amare"
stringa3 = null
console.log("abbiamo sostituito la striga - odiare con un valore Null")
...
*/
console.log("ESERCIZIO 2 Crea una variable chiamata (myName)e assegna ad essa il tuo nome, sotto forma di stringa.")
const myName = "Teo"
console.log(myName) 
